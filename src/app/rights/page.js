    ...
    <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="relative mb-12 text-center py-10 rounded-3xl glass border border-surface-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-[family-name:var(--font-outfit)] text-text-primary mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="glass p-5 space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-text-secondary">Search Rights</h3>
          ...
          <div className="glass p-5 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-bold uppercase tracking-wider text-text-secondary">Categories</h3>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {filteredRights.length === 0 ? (
            <div className="glass p-12 text-center rounded-2xl border border-surface-light shadow-xl">
              ...
              <h3 className="text-lg font-bold text-text-primary mb-2">No matching rights found</h3>
