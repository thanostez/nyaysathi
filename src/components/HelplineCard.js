export default function HelplineCard({ helpline }) {
  ...
  return (
    <div className="glass rounded-2xl p-5 sm:p-6 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 hover:border-primary/25">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <span className="relative flex size-2.5">
              <span
                ...
                aria-hidden="true"
              />
              <span className="relative inline-flex size-2.5 rounded-full bg-success" aria-hidden="true" />
            </span>
      ...
      >
        <svg className="size-6 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
